...
export default function Complete(){
    ...
    return(
        <div style={{display:'flex', justifyContent:'center', alignContent:'center', alignItems:'center', textAlign:'center', overflowX:'hidden', overflowY:'scroll', scrollbarWidth:'thin', scrollBehavior:'smooth'}}>
