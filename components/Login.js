        ...
        <div className="container">
            ...
            <form className="mx-auto">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', marginTop: '0.8rem', marginBottom:'2rem' }}>
                    ...
                    <button type='button' className='google' onClick={handleOAuth} style={{ borderRadius:'5%', boxShadow:'0 0 0.71rem black', display:'flex', flexDirection:'row', justifyContent:'center', cursor: 'pointer', margin:'auto', fontSize:'1.2rem', padding:'0.2rem', marginTop: '0.5rem', color:'black', backgroundColor:'white' }}>
                        <svg viewBox="0 0 128 128" style={{width:'1.8rem'}}>
