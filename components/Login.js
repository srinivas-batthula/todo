        ...
        <div className="container">
            ...
            <form className="mx-auto">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', justifyItems:'center', alignItems:'center', marginTop: '0.8rem', marginBottom:'2rem' }}>
                    ...
                    <button type='button' className='google' onClick={handleOAuth} style={{ paddingLeft:'0.3rem', paddingRight:'0.3rem', paddingTop:'0.2rem', paddingBottom:'0.2rem', borderRadius:'3%', boxShadow:'0 0 0.2rem rgb(0, 115, 255)', display:'flex', flexDirection:'row', justifyContent:'center', textAlign:'center', cursor: 'pointer', fontSize:'1.2rem', marginTop: '0.6rem', color:'white', backgroundColor:'rgb(30, 131, 255)' }}>
                        <svg viewBox="0 0 128 128" style={{width:'2rem', backgroundColor:'rgb(233, 233, 233)', borderRadius:'9%', padding:'0.3rem', marginRight:'0.6rem'}}>
